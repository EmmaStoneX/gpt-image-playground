...
export default function Header() {
  ...
  const iconBtn =
    'flex h-9 w-9 items-center justify-center rounded-[10px] text-gray-500 transition-colors hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/[0.06]'
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          <div className="relative">
            ...
            <input
              ...
              type="text"
              placeholder="搜索提示词…"
              className="h-9 w-32 rounded-[10px] bg-gray-100 pl-9 pr-3 text-sm text-gray-700 outline-none transition-[width,box-shadow] placeholder:text-gray-400 focus:w-44 focus:ring-2 focus:ring-blue-500/25 dark:bg-white/[0.06] dark:text-gray-200 dark:placeholder:text-gray-500 sm:w-44 sm:focus:w-60"
            />
          </div>
